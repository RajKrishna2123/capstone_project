...
function Security() {
  return (
      <div className="child flex flex-row relative items-center justify-center w-full h-full">
          <div className="absolute w-auto h-auto top-0 z-[5] translate-y-[100px]">
          ...
          <div className="fade-in-content w-full flex items-start justify-center translate-y-[50px] z-[-2] absolute">
              <video
                  loop
                  muted
                  autoPlay
